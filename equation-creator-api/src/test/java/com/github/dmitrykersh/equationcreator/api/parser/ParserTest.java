...
class ParserTest {
    ...
    public void negateValue_ALL_IN_ONE(final String arg, final String res) {
    ...
    public void evaluateSimpleEquation_VALID_INPUT(final String arg, final String res) {
        assertEquals(res, Parser.evaluateSimpleEquation(arg));
    }

    @ParameterizedTest
    @ValueSource(strings = {"2 + 3", "12 - 6as", "2 ^$ 3", "2$^3"})
    public void evaluateSimpleEquation_WRONG_INPUT(final String arg) {
    ...
    public void evaluateSimpleEquation_MIXED_INPUT(final String arg, final String res) {
    ...
    public void evaluateSimpleEquation_LONG_EQUATIONS(final String arg, final String res) {
        assertEquals(res, Parser.evaluateSimpleEquation(arg));
    }
    ...
    public void createEquation_NO_PARSING(final String arg) {
        assertEquals(arg, Parser.parseWithEscaping(random, arg));
    }
    ...
    public void createEquation_INT_RANGE(final String format, final List<String> allowedValues) {
        assertTrue(allowedValues.contains(Parser.parseWithEscaping(random, format)));
    }
