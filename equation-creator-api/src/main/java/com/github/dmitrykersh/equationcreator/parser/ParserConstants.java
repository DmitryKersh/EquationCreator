...
import static com.github.dmitrykersh.equationcreator.parser.ParserConstants.ParserRegexStrings.DECIMAL;
...
public class ParserConstants {
    ...
    public static class ParserRegexPatterns {
        ...
        public static final Pattern ARITH_BRACKETS_PATTERN = Pattern.compile("\\(" + DECIMAL + "(\\s\\$[+\\-/*\\^]\\s" + DECIMAL + ")+\\)");
        public static final Pattern ARITH_NO_BRACKETS_PATTERN = Pattern.compile(DECIMAL + "(\\s\\$[+\\-/*\\^]\\s" + DECIMAL + ")+");
